...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default="D:/Neural_Style_Transfer/content_data", help='Location of content dataset')

    parser.add_argument('--style_dir', type=str, default="D:/Neural_Style_Transfer/style_data", help='Location of style dataset')

    parser.add_argument('-vgg', type=str, default="D:/Neural_Style_Transfer/vgg_normalised.pth", help='Location of pre-trained VGG')
    ...
    parser.add_argument('--style_size', type=int, default=256, help='size of content image')
...
def main():
    ...
    for epoch in range(args.epochs):
        progress_bar = tqdm(zip(content_dataloader, style_dataloader), total=min(len(content_dataloader), len(style_dataloader)), ncols=100, leave=True)
